...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	protected void createFieldEditors() {
		...
		// var sonarEnable = new BooleanFieldEditor(SONAR_ENABLE, "Использовать SonarLint", parent);
		// addField(sonarEnable);
		...
		var sonarProjectKey = new StringFieldEditor(PreferenceManager.SONAR_PROJECT_KEY, "Ключ проекта", parent);
		addField(sonarProjectKey);
	}
